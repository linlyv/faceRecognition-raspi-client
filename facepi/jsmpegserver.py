...
class StreamingHttpHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path == '/':
            ...
            self.send_header('Location', '/home/pi/facepi/index.html')
            self.end_headers()
            return
        elif self.path == '/home/pi/facepi/jsmpg.js':
            content_type = 'application/javascript'
            content = self.server.jsmpg_content
        elif self.path == '/home/pi/facepi/index.html':
...
class StreamingHttpServer(HTTPServer):
    def __init__(self):
        ...
        with io.open('/home/pi/facepi/index.html', 'r') as f:
            self.index_template = f.read()
        with io.open('/home/pi/facepi/jsmpg.js', 'r') as f:
...
class StreamingWebSocket(WebSocket):
    ...
    def closed(self,code,reason=None):
        global clientcount
        clientcount = clientcount - 1
        print("onclose,clientcount==",clientcount)
        os._exit(0)
